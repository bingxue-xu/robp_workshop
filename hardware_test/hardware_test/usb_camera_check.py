# hardware_ws/src/hardware_test/hardware_test/usb_camera_check.py
...
class UsbCameraCheck(BaseTest):
    def __init__(self):
        super().__init__(
            node_name='usb_camera_check',
        ...
        self.hardware_key = 'USBCamera'
        self.topic_name = self.declare_parameter('topic_name', '/image_raw').value
