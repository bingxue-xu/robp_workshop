...
public:
    ICPOdometry()
    : Node("icp_odometry"), first_cloud_(true)
    {
        scan_sub_ = this->create_subscription<sensor_msgs::msg::LaserScan>(
            "/scan", 10, std::bind(&ICPOdometry::scan_callback, this, _1));
        pointcloud_sub_ = this->create_subscription<sensor_msgs::msg::PointCloud2>(
            "/lidar/points_raw", 10, std::bind(&ICPOdometry::pointcloud_callback, this, _1));
        pointcloud_pub_ = this->create_publisher<sensor_msgs::msg::PointCloud2>("/lidar/points_raw", 10);
...
private:
    ...
    void pointcloud_callback(const sensor_msgs::msg::PointCloud2::SharedPtr msg) {
        ...
        *last_cloud_ = *current_cloud;
        ...
        publish_odometry(msg->header.stamp, delta);
    }
...
int main(int argc, char **argv) {
    ...
    rclcpp::spin(std::make_shared<ICPOdometry>());
    rclcpp::shutdown();
    return 0;
}
