...
class Odometry(Node):
    ...
    def __init__(self):
        ...
        self.create_timer(0.0002, self.timer_callback)
    ...
    def encoder_callback(self, msg: Encoders):
        ...
        dt = 50 / 1000
        ticks_per_rev = 48 * 64
        wheel_radius = 0.098425/2   # TODO: Fill in
        base =  0.311  # TODO: Fill in #optimized wheelbase

        #refresh rate = 20HZ ie timer = 0.05
        #E_T is ticks per rev
        ...
        #stamp = self.get_clock().now().to_msg() # TODO: Fill in
