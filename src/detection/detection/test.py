...
image = cv2.imread('/home/rosuser/Desktop/temp.jpg')  # Replace 'your_image.jpg' with the actual file path
...
initial_hsv_upper = np.array([360, 255, 255])
...
cv2.createTrackbar('Hue Lower', 'HSV Trackbars', initial_hsv_lower[0], 360, on_trackbar_change)
...
cv2.createTrackbar('Hue Upper', 'HSV Trackbars', initial_hsv_upper[0], 360, on_trackbar_change)
